                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="checkbox col-md-6">
                                <?php $newsletters = App\Newsletter::all(); ?>
                                @foreach($newsletters as $newsletter)
                                <label><input id="newsletters" type="checkbox" name="newsletters[]" value="{{$newsletter->id}}">{{$newsletter->newsletter}}</label>
                                @endforeach
                                @if ($errors->has('newsletters'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('newsletters') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
